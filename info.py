...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+5zIQm8jLvdxiMmE1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://telegram.me/svfilmsx_official')
MSG_ALRT = environ.get('MSG_ALRT', 'ꜱʜᴀʀᴇ  ᴀɴᴅ  ꜱᴜᴘᴘᴏʀᴛ  ᴜꜱ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'avfilmshelpbot')
